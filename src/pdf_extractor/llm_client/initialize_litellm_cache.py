...
if __name__ == "__main__":
    ...
    try:
        ...
        if test_result:
            ...
            logger.error(f"   Expected first call cache_hit=False/None, second call cache_hit=True.")
            logger.error(f"   Got: cache_hit1={details.get('cache_hit1')}, cache_hit2={details.get('cache_hit2')}")
