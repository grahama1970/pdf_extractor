#!/usr/bin/env python3
# Basic table merger implementation for multi-page tables
...
def merge_table_data(table1, table2):
    ...
    # Skip second table's header if similar to first table's header
...
# Function to process camelot tables
