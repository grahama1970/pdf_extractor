#!/usr/bin/env python3
# tests/pdf_extractor/arangodb/search_api/test_semantic.py
...
class TestSemanticSearch(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.fixture_path = "src/test_fixtures/semantic_search_expected_20250422_181101.json"
    
    def validate_semantic_search(self, search_results: Dict[str, Any], fixture_path: str) -> Tuple[bool, Dict[str, Dict[str, Any]]]:
        """
    ...
    def test_semantic_search(self):
        ...
        validation_passed, validation_failures = self.validate_semantic_search(search_results, self.fixture_path)
        
        # Check if validation passed
        self.assertTrue(validation_passed, f"Semantic search validation failed: {validation_failures}")
