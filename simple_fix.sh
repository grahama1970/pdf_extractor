#!/bin/bash
# Create a simplified version of the ArangoDB integration with correct string handling

cat > /home/graham/workspace/experiments/pdf_extractor/src/pdf_extractor/arangodb/pdf_integration_new.py << 'PYTHONFILE'
#!/usr/bin/env python3
'''
...
chmod +x /home/graham/workspace/experiments/pdf_extractor/src/pdf_extractor/arangodb/pdf_integration_new.py

# Test the implementation
cd /home/graham/workspace/experiments/pdf_extractor && source .venv/bin/activate && python -c import pdf_extractor.arangodb.pdf_integration_new

# Update the original file
cp /home/graham/workspace/experiments/pdf_extractor/src/pdf_extractor/arangodb/pdf_integration_new.py /home/graham/workspace/experiments/pdf_extractor/src/pdf_extractor/arangodb/pdf_integration.py

echo Fixed ArangoDB integration with properly formatted strings
